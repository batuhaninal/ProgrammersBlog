...
namespace ProgrammersBlog.Services.Abstract
{
    public interface IArticleService
    {
        ...
        Task<IDataResult<ArticleListDto>> GetAllAsync(int? categoryId, int? userId, bool? isActive, bool? isDeleted, int currentPage, int pageSize, OrderByGeneral orderBy, bool isAscending, bool includeCategory, bool includeComments, bool includeUser);
